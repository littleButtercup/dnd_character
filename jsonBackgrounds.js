window.backgrounds = {Прислужник:{abilities:{characterSkillsDiscernment: true, characterSkillsReligion:true}},
...
window.feature = {Прислужник: [ 'Я идеализирую конкретного героя своей веры и постоянно ссылаюсь на его поступки и свершения',
...
window.ideal = {Прислужник: {Традиции:{Характер:'законный', Описание:'Мы должны сохранить и защитить древние традиции богослужения и совершения священных таинств'},
...
Шарлатан: {Независимость: {Характер: 'хаотичный', Описание: 'Мы должны сохранить и защитить древние традиции богослужения и совершения священных таинств'},
...
Преступник: {Честь: {Характер: 'законный', Описание: 'Я не краду у своих «коллег»'},
...
Артист: {Красота: {Характер: 'добрый', Описание: 'Выступая, я делаю мир лучше'},
...
'Народный герой': {Уважение: {Характер: 'добрый', Описание: 'Нужно относиться друг к другу с достоинством и уважением'},
...
'Гильдейский ремесленник': {Сообщество: {Характер: 'законный', Описание: 'Все цивилизованные народы обязаны укреплять сообщество и обеспечивать безопасность цивилизации'},
...
Отшельник: {'Всеобщее благо': {Характер: 'добрый', Описание: 'Мои дары предназначены для всех, я не должен использовать их в одиночку'},
...
Благородный: {Уважение: {Характер: 'добрый', Описание: 'Уважение — мой долг. Кем бы ты ни был, к другим нужно относиться с уважением, невзирая на их происхождение'},
...
Чужеземец: {Перемены: {Характер: 'хаотичный', Описание: 'Жизнь как времена года, постоянно меняется, и мы должны меняться вместе с ней'},
...
Мудрец: {Знание: {Характер: 'нейтральный', Описание: 'Путь к силе и самосовершенствованию лежит в знаниях'},
...
Моряк: {Уважение: {Характер: 'добрый', Описание: 'Корабль держится целым благодаря взаимному уважению капитана и экипажа'},
...
Солдат: {'Высшее благо': {Характер: 'хаотичный', Описание: 'Наш жребий — отдать свои жизни ради других'},
...
Беспризорник: {Уважение: {Характер: 'добрый', Описание: 'Все люди, богатые ли они, или бедные, достойны уважения'},
...
window.weakness = { Прислужник: ['Я не проявляю снисходительности к другим, но к себе я ещё более суров',
